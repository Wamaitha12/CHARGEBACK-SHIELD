    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-28 pb-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose-content space-y-10 text-slate-600 leading-relaxed">
            ...
            <section>
              ...
              <h3 className="text-base font-semibold text-slate-900 mb-2">Information you provide</h3>
              ...
              <h3 className="text-base font-semibold text-slate-900 mb-2">Information collected automatically</h3>
            ...
            <section>
              <h2 className="text-xl font-semibold text-slate-900 mb-3">4. Sharing Your Information</h2>
              <p className="mb-4">
                We do not sell, trade, or rent your personal information to third parties. We may share information in
                the following limited circumstances:
              </p>
              <ul className="list-disc list-inside space-y-1.5 text-sm">
                <li><strong className="text-slate-900">Service providers:</strong> Trusted third parties that help us operate our platform (e.g., cloud hosting, payment processing, email delivery)</li>
                ...
                <li><strong className="text-slate-900">Business transfers:</strong> In connection with a merger, acquisition, or sale of assets, with appropriate notice</li>
                <li><strong className="text-slate-900">Your consent:</strong> With your explicit permission for any other purpose</li>
              </ul>
            </section>
